...
$rninstance->AddScript('shared','js/dist/InternalShared_bundle.js',array('jquery', 'wp-element','rnmobx','regenerator-runtime'));
...
if($loader->IsPR())
{
    ...
    $rninstance->AddScript('builderpr','js/dist/pageBuilderReactPR_bundle.js',array('jquery',  'wp-element','regenerator-runtime'));
...
<div style="position: fixed;top:0;left:0;width: 100%;height: 100%;z-index: 99999;background-color: white;">
    ...
    <div id="AppRot" style="width:100%;height: 100%;">
        <div style="width:100%;height:100%;display: flex;text-align: center;justify-content: center;align-items: center;flex-direction: column;">
            ...
            <h1 style="margin:0;padding:0;"><?php echo __("Loading important stuffs, please wait =)","pdf-builder-for-wpforms")?></h1>
        </div>
    </div>
