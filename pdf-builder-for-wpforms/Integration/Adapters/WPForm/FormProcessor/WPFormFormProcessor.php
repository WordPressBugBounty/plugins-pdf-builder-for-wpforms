...
use rednaoformpdfbuilder\Integration\Adapters\WPForm\Settings\Forms\Fields\WPFormRepeaterFieldSettings;
        ...
        foreach($fieldList as $field)
        {
            switch($field->type)
            {
                ...
                case 'html':
                    ...
                    break;
                case 'repeater':
                    $fieldSettings[]=(new WPFormRepeaterFieldSettings())->Initialize($field->id,'Repeater',$field->type)->SetColumns($field->columns);
                    break;
            }
        }
