...
class TemplateListAjax extends AjaxBase
{
    ...
    protected function RegisterHooks()
    {
        ...
        add_action('wp_ajax_pdf_builder_dont_show_again_notice', array($this, 'DontShowAgainNotice'));

    }

    public function DontShowAgainNotice()
    {
        update_option('automation_dont_show_again', true);
    }
